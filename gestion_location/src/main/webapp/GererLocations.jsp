                ...
                <% for (Location l : locations) { %>
                  <tr class="odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition">
                    ...
                    <td class="py-3 px-6 text-center">
                      <span class="<%= " En cours".equals(l.getStatut()) ? "bg-yellow-100 text-yellow-800" : "bg-green-100 text-green-800" %>
                      ...
                      <form action="LocationServlet" method="post">
                        ...
                        <select name="statut" onchange="this.form.submit()" class="border rounded p-1">
                          <option value="En cours" <%= l.getStatut().equals("En cours") ? "selected" : "" %>>En cours</option>
                          <option value="Confirmé" <%= l.getStatut().equals("Confirmé") ? "selected" : "" %>>Confirmé</option>
                        </select>
                      </form>
                    </td>
