    ...
    <body
        ...
        <div class="container max-w-5xl mx-auto relative z-10 h-200">
            <div class="flex flex-col md:flex-row rounded-3xl shadow-2xl glassmorphism">
                ...
                <div class="w-full bg-white-900 p-8 rounded-3xl flex flex-col items-center justify-center">
                    <div class="mb-8 text-center">
                        ...
                        <% if (request.getParameter("error") !=null) { String errorMsg="" ; String
                            errorType=request.getParameter("error"); switch(errorType) { case "google_auth_error" :
                            errorMsg="Erreur lors de la connexion avec Google. Veuillez réessayer." ; break;
                            case "invalid_oauth_state" : errorMsg="Session OAuth invalide. Veuillez réessayer." ; break;
                            case "no_auth_code" :
                            errorMsg="Aucun code d'autorisation reçu de Google. Connexion annulée." ; break;
                            case "user_creation_failed" : errorMsg="Échec de la création du compte. Veuillez réessayer."
                            ; break; case "client_creation_failed" :
                            errorMsg="Échec de l'enregistrement du client. Veuillez réessayer." ; break;
                            case "google_auth_processing_error" :
                            errorMsg="Erreur lors du traitement de l'authentification Google. Veuillez réessayer." ;
                            break; default: errorMsg="Une erreur s'est produite. Veuillez réessayer." ; } %>
                    ...
                    <form action="RegistrationServlet" method="post" class="md:grid md:grid-cols-2 md:gap-6"
                        id="registerForm">
            ...
            <div class="mt-10 text-center relative">
                <div class="flex justify-center space-x-12">
                    <div class="text-white text-xs" id="car1">
                        ...
                        <div class="mt-2"><span class="bg-white/10 backdrop-blur-md px-3 py-1 rounded-full">Sedan
                                Premium</span></div>
                    </div>
                    <div class="text-white text-xs" id="car2">
                        <i class="fas fa-truck-monster text-2xl"></i>
                        <div class="mt-2"><span class="bg-white/10 backdrop-blur-md px-3 py-1 rounded-full">SUV de
                                Luxe</span></div>
                    </div>
                    <div class="text-white text-xs" id="car3">
                        <i class="fas fa-car-side text-2xl"></i>
                        <div class="mt-2"><span
                                class="bg-white/10 backdrop-blur-md px-3 py-1 rounded-full">Sportive</span></div>
                    </div>
                </div>
