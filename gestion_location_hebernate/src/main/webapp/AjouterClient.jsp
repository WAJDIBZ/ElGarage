...
<body class="bg-gray-50 min-h-screen car-pattern">
    <div class="flex">
        <!-- Sidebar -->
        <div class="fixed h-screen w-64 bg-primary-800 text-white shadow-lg z-10">
            <div class="p-5 border-b border-primary-700">
                <h2 class="text-2xl font-bold animate__animated animate__fadeIn">AutoGestion</h2>
                <p class="text-xs text-primary-300 animate__animated animate__fadeIn animate__delay-1s">Location de voitures</p>
            </div>
            <nav class="mt-6">
                ...
                <a href="#" class="flex items-center py-3 pl-6 pr-4 hover:bg-primary-700 transition duration-200">
