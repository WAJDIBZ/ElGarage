    ...
    <div class="container max-w-5xl mx-auto relative z-10 h-200">
        <div class="flex flex-col md:flex-row rounded-3xl shadow-2xl overflow-hidden glassmorphism">
            ...
            <div class="w-full md:w-1/2 car-bg relative hidden md:block">
                ...
                <div class="absolute top-8 left-8 bg-black/70 backdrop-blur-md px-4 py-2 rounded-full animate-float" style="animation-delay: 0s">
                ...
                <div class="absolute top-8 right-8 bg-black/70 backdrop-blur-md px-4 py-2 rounded-full animate-float" style="animation-delay: 1s">
                    <div class="flex items-center space-x-2">
                ...
                <div class="absolute bottom-40 left-8 bg-black/70 backdrop-blur-md px-4 py-2 rounded-full animate-float" style="animation-delay: 2s">
                    <div class="flex items-center space-x-2">
            ...
            <div class="w-full md:w-1/2 p-8 md:p-12 bg-white/90 backdrop-blur-lg">
                ...
                <form action="AuthServlet" method="post" class="space-y-6" id="loginForm">
                    <div class="opacity-0" id="adresseField">
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fas fa-envelope text-gray-400 group-hover:text-blue-500 transition-colors"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="opacity-0" id="passwordField">
                        ...
                        <div class="relative group">
                            <input type="password" id="password" name="password" required
                                   class="w-full px-4 py-4 rounded-xl border border-gray-300 focus:ring-3 focus:ring-blue-500/30 focus:border-blue-500 transition-all pl-12 group-hover:shadow-md">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fas fa-lock text-gray-400 group-hover:text-blue-500 transition-colors"></i>
                            </div>
                    ...
                    <div class="opacity-0 mt-4" id="loginOptions">
                        ...
                        <div class="flex space-x-3 mt-4">
                            <button type="button" class="flex-1 flex justify-center items-center py-3 px-4 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 transition-colors shadow-sm">
                ...
                <div class="mt-8 text-center opacity-0" id="registerField">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="Inscription.jsp" class="text-blue-600 hover:text-blue-800 font-medium transition-colors underline">
                            Créer un compte
                        </a>
                    </p>
                </div>
